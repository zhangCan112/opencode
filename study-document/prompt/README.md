...
| [15-copilot-gpt-5.md](15-copilot-gpt-5.md)           | Copilot GPT-5     | Copilot 专用提示词         |
| [16-anthropic-20250930.md](16-anthropic-20250930.md) | Claude 2025-09-30 | 特定日期版本               |
...
| [13-plan-reminder-anthropic.md](13-plan-reminder-anthropic.md) | plan       | Anthropic 增强计划模式 |

### 动态注入提醒

| 文件                                     | 触发条件     | 说明               |
| ---------------------------------------- | ------------ | ------------------ |
| [12-build-switch.md](12-build-switch.md) | 计划→构建    | 计划切换到构建提醒 |
| [14-max-steps.md](14-max-steps.md)       | 达到最大步数 | 最大步数到达提醒   |
...
│                                                             │
│   1. 根据模型 ID 选择主系统提示词：                          │
│      - gpt-5 → codex_header.txt / copilot-gpt-5.txt      │
│      - gpt-* / o1 / o3 → beast.txt                        │
│      - claude → anthropic.txt / anthropic-20250930.txt    │
│      - gemini-* → gemini.txt                               │
│      - trinity → trinity.txt                               │
│      - 其他 → qwen.txt                                     │
│                                                             │
...
│                                                             │
│   3. 动态注入（根据会话状态）：                               │
│      - plan 模式 → plan.txt / plan-reminder-anthropic.txt  │
│      - 最大步数 → max-steps.txt                             │
│      - 构建切换 → build-switch.txt                          │
│                                                             │
└─────────────────────────────────────────────────────────────┘
```
...
完整顺序：agent.prompt → input.system → user.system（用 "\n" 连接）
